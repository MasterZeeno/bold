    ...
    var t, e, n = {
        ...
        5083: function(t, e, n) {
            ...
            e.ZP = function(t, e) {
                ...
                "string" == typeof g.volume && (g.volume = parseFloat(g.volume)),
                g.volume = (0,
                a.qh)(g.volume) ? Math.min(Math.max(0, g.volume), 100) : f.volume,
                g.mute = Boolean(g.mute),
                g.language = h,
                g.intl = v;
                ...
                if (k)
                    ...
                    var C = (0,
                    a.ei)(g, ["title", "description", "type", "mediaid", "image", "images", "file", "sources", "tracks", "preload", "duration", "chapters"]);
                    g.playlist = [C]
                }
                ...
                g.liveTimeout = P);
                var j, x, S = parseFloat(g.bandwidthEstimate), E = parseFloat(g.bitrateSelection);
        ...
        623: function(t, e, n) {
            ...
            var E = n(1918)
              ...
              , N = function(t) {
                return new Promise((function(e) {
                    if (t.attributes.liveSyncDuration > 45)
                        return e((0,
                        d.l9)(new Error, d.wM));
              ...
              , D = function(t) {
                ...
                this.start = function(n) {
                    var r, i = B(t, n), o = Promise.all([(r = t,
                    h || (h = m(r)),
                    h), N(t), i, _(t), F(t), O(t), L(t)]), u = new Promise((function(t, n) {
            ...
            function(t, e) {
              ...
              , nt = function(t) {
                ...
                this.modelShim._qoeItem = new q.Z,
                this.mediaShim = {},
            ...
            r.Z)(nt.prototype, {
                ...
                init: function(t, e) {
                    ...
                    J.Z)(l.getPrimedElement(), l));
                    var f = this.primeUi = new $.ZP((0,
                    $.GU)(this.originalContainer)).once("gesture", (function() {
                        l.prime(),
                        n.preload(),
                        f.destroy()
                    }
                        ...
                        n.setup && function(t, e, n) {
                            Promise.resolve().then((function() {
                                ...
                                if (!o) {
                                    var u = (0,
                                    Q.Z)(t, r);
                                    Q.Z.cloneIcon && u.querySelector(".jw-icon").appendChild(Q.Z.cloneIcon("error")),
                                    et(t, u)
                                }
                                i.set("errorEvent", r),
                                i.set("state", y.Vy),
        ...
        4446: function(t, e, n) {
            ...
            var r = n(6042)
              ...
              , A = function(t, e) {
                var n = O(T, e, t);
                return n.code = (t && t instanceof Z && t.code || 0) + e,
                n
            }
              , _ = function(t) {
                var e = t.name
                ...
                r.my)(e); s++) {
                    ...
                    if ("media" === l.prefix) {
                        ...
                        case "subtitle":
                            ...
                            (0,
                            i.Dc)(l, "lang").length > 0 && (p.label = (u = (0,
                            i.Dc)(l, "lang"),
                            a = void 0,
                            (a = {
                                zh: "Chinese",
        ...
        393: function(t, e, n) {
            ...
            var r = n(7462)
              ...
              , s = function(t) {
                ...
                return e.sources = e.sources.filter(Boolean),
                c(e.tracks) || (e.tracks = []),
                c(e.captions) && (e.tracks = e.tracks.concat(e.captions),
                delete e.captions),
                e.tracks = e.tracks.map(u).filter(Boolean),
                e
            }
        },
        7263: function(t, e, n) {
            ...
            e.Z = function() {
                ...
                r.Z)(this, c.ZP)
                  ...
                  , n = function(n) {
                    try {
                        var a, c = n.responseXML ? n.responseXML.childNodes : null, l = null;
                        if (c) {
            ...
            var r = n(7462)
              ...
              , h = function(t, e, n) {
                var i = t.getProviders()
                  ...
                  , c = (0,
                r.Z)({}, e);
                if (c.preload = o(e.preload, u),
                c.allSources = d(c, t),
                c.sources = p(c.allSources, i),
                c.sources.length)
                    return c.file = c.sources[0].file,
                    c.feedData = n,
                    c.starttime = -1 !== a && t.get("generateSEOMetadata") ? a : c.starttime,
                    function(t) {
                ...
                return (e[1].includes("#") ? e[1].split("#")[0] : e[1]).split("&").forEach((function(t) {
                    ...
                    !function(t, e) {
                        if (null == t)
                            throw new TypeError("Cannot convert undefined or null to object");
                        return Object.prototype.hasOwnProperty.call(Object(t), e)
                    }(n, r) ? n[r] = o : (Array.isArray(n[r]) || (n[r] = [n[r]]),
                    n[r].push(o))
                }
                )),
                n
            ...
            var r = n(7462)
              ...
              , p = function(t, e, n, i) {
                ...
                if ("XMLHttpRequest"in window) {
                    if (l = p.xhr = p.xhr || new window.XMLHttpRequest,
                    "function" == typeof p.requestFilter) {
                        var v;
                        try {
                            v = p.requestFilter({
                                url: t,
                    ...
                    l.onreadystatechange = function(t) {
                        return function(e) {
                            ...
                            if (4 === n.readyState) {
                                ...
                                var r = n.status;
                                if (r >= 400)
                                    return void s(t, u.ul, r < 600 ? r : 6);
                                if (200 === r)
                                    return f(t)(e);
                                0 === r && (0,
                                o.isFileProtocol)() && !/^[a-z][a-z0-9+.-]*:/.test(t.url) && s(t, u.ul, 7)
                            }
                        }
                    }(p),
                    l.onerror = h,
                    "overrideMimeType"in l ? p.mimeType && l.overrideMimeType(p.mimeType) : p.useDomParser = !0;
                    try {
                        t = t.replace(/#.*$/, ""),
                        l.open("GET", t, !0)
                    } catch (t) {
                    ...
                    try {
                        p.withCredentials && "withCredentials"in l && (l.withCredentials = !0),
                        l.send()
                    } catch (t) {
                        h(t, 4)
                    }
        ...
        328: function(t, e, n) {
            ...
            var r = function(t, e) {
              ...
              , u = function(t, e, n, i) {
                ...
                if ("object" == typeof n) {
                    for (var u in n)
                        r(n, u) && t[e].apply(t, [u, n[u]].concat(i));
                    return !1
                }
                if (o.test(n)) {
                    for (var a = n.split(o), c = 0, s = a.length; c < s; c++)
                        t[e].apply(t, [a[c]].concat(i));
                    return !1
                }
                return !0
            }
              , a = function() {
                ...
                e.triggerSafe = function(t) {
                    ...
                    var o = this._events[t]
                      , a = this._events.all;
                    return o && i(o, n, this, t),
                    a && i(a, arguments, this, t),
                    this
                }
                ,
                t
        ...
        8381: function(t, e, n) {
            ...
            var r = n(8518)
              ...
              , a = function(t, e) {
                ...
                return i.forEach((function(o, a) {
                    var c = function(t, e) {
                        void 0 === e && (e = "en");
                        for (var n = (0,
                        r.G3)(), i = Object.keys(t.title), o = i[0]; !t.title[n]; ) {
                            var a = i.find(u(n));
                            if (a) {
                                n = a;
                                break
              ...
              , c = function(t, e) {
                ...
                return e ? (e.timestamps = o,
                e) : new i.t(n,o)
            }
              , s = function(t, e) {
                if ("number" != typeof t || t < 0 || !e || !e.length)
                    return null;
        ...
        974: function(t, e, n) {
            ...
            var r, i = n(2957), o = n(9563), u = n.n(o), a = function(t, e) {
                if (null == t)
                    throw new TypeError("Cannot convert undefined or null to object");
                return Object.prototype.hasOwnProperty.call(Object(t), e)
            }, c = u().clear, s = function(t) {
                t = t.split("-");
                ...
                if ("object" == typeof e) {
                    ...
                    a(e, "content") && c && (c = c + ' content: "' + e.content + '";'),
        ...
        2799: function(t, e, n) {
            ...
            var r, i = n(7462), o = n(2957), u = n(6042), a = n(8348), c = window.DOMParser, s = !0, l = function(t, e) {
                ...
                return t
            }, p = /^((((https?):\/\/)|(mailto:))(%[0-9A-Fa-f]{2}|[-()_.!~*';/?:@&=+$,A-Za-z0-9])+)([).!';/?:,][[:blank:|:blank:]])?$/, h = function(t) {
                for (var e = t.attributes, n = e.length; n--; ) {
                    var r = e[n].name;
                    if (/^on/.test(r) && t.removeAttribute(r),
                    /href/.test(r)) {
                        var i = e[n].value;
                        !/javascript:|javascript&colon;/.test(i) && p.test(i) || (t.removeAttribute(r),
                ...
                function(t, e) {
                    if (e) {
                        for (var n = document.createDocumentFragment(), r = v(e).childNodes, i = 0; i < r.length; i++)
        ...
        9888: function(t, e, n) {
            ...
            var r = n(7034)
              ...
              , u = function(t, e) {
                ...
                if (o(t))
                    return t;
                var n, i = e.substring(0, e.indexOf("://") + 3), u = e.substring(i.length, e.indexOf("/", i.length + 1));
                if (0 === t.indexOf("/"))
                    n = t.split("/");
                else {
                    var a = e.split("?")[0];
              ...
              , l = function(t, e) {
                if ((0,
                i.i2)(t) && (t = parseInt(t.toString(), 10)),
                (0,
        ...
        1569: function(t, e, n) {
            ...
            var r = n(6601)
              ...
              , u = function() {
                var t = "//ssl.p.jwpcdn.com/player/v/8.26.2";
                return "" + ((0,
        ...
        5882: function(t, e, n) {
            ...
            var r, i, o = n(4578), u = n(8348), a = n(1643), c = n(328), s = n(5004), l = n(2799), f = "ontouchstart"in window, d = "PointerEvent"in window && !u.OS.android, p = !(d || f && u.OS.mobile), h = "window", v = "init", g = "select", m = "keydown", y = u.Features.passiveEvents, w = !!y && {
                ...
                if (i || (i = new I(document).on("interaction")),
                ...
                d ? P(t, e, "pointerdown", n, r) : (p && P(t, e, "mousedown", n, r),
                P(t, e, "touchstart", n, r))
            }, Z = function(t) {
                if (!t.handlers.select) {
                    ...
                    T(t, g, (function(n) {
                        var r = n.target;
                        S(n) || Boolean(t.directSelect) && r !== e || (n.isPrimary && "BUTTON" === r.tagName && r.focus(),
                        t.lastStart = (0,
                        s.z)(),
                        t.clicking = !0)
                    }
                    ...
                    P(t, g, "click", (function(n) {
                        S(n) || Boolean(t.directSelect) && n.target !== e || ((0,
                        s.z)() - t.lastStart > 500 && !0 === t.clicking || (function(t, e) {
                            t.enableDoubleClick && ((0,
                            s.z)() - t.lastClick < 300 ? (b(t, a.P, e),
                        ...
                        !S(r)) {
                            ...
                            if (!t.directSelect || a === e) {
                                ...
                                "pointerdown" === c && r.isPrimary) {
                                    ...
                                    P(t, h, "pointermove", o, i),
                                    P(t, h, "pointercancel", u),
                                    P(t, h, "pointerup", u)
                                } else
                                    "mousedown" === c ? (P(t, h, "mousemove", o, i),
                                    P(t, h, "mouseup", u)) : "touchstart" === c && (P(t, h, "touchmove", o, i),
                                    P(t, h, "touchcancel", u),
                                    P(t, h, "touchend", u))
                            }
                        }
                ...
                out: function(t) {
                    if (d) {
                        ...
                        p && P(t, a.U3, "mouseout", (function(e) {
                            b(t, a.U3, e)
                        }
                        ))
                },
                ...
                function e(e, n) {
                    ...
                    return r.directSelect = Boolean(n.directSelect),
                    r.dragged = !1,
                ...
                return n.on = function(e, n, r) {
                    return F(e) && (this.handlers[e] || _[e](this)),
        ...
        6042: function(t, e, n) {
            ...
            var r = n(5004)
              ...
              , E = function(t, e, n) {
                ...
                if (v && t.forEach === v)
                    ...
                    for (r = 0,
                    i = t.length; r < i; r++)
                        if (e.call(n, t[r], r, t) === o)
                            return
                } else {
                    var u = S(t);
                    for (r = 0,
                    i = u.length; r < i; r++)
                        if (e.call(n, t[u[r]], u[r], t) === o)
                            return
                }
                return t
            }
            ...
            var nt = function(t) {
              ...
              , dt = function(t, e) {
                return null != t && (t.length !== Number(t.length) && (t = function(t) {
                    for (var e = S(t), n = S.length, r = Array(n), i = 0; i < n; i++)
                        r[i] = t[e[i]];
                    return r
                }(t)),
                ft(t, e) >= 0)
              ...
              , yt = function(t) {
                ...
                return function() {
                    for (var e = arguments.length, r = new Array(e), i = 0; i < e; i++)
                        r[i] = arguments[i];
                    for (var o = 0, u = n.slice(), a = 0, c = u.length; a < c; a++)
                        j(u[a], "partial") && (u[a] = r[o++]);
            ...
            e.ZP = {
                ...
                matches: ht,
                max: function(t, e, n) {
                    if (!e && I(t) && t[0] === Number(t[0]) && t.length < 65535)
        ...
        6601: function(t, e, n) {
            ...
            var r = "8.26.2+commercial_v8-26-2.512.hls.js@1.2.1.jwplayer@mono.jwplayer-ads-dai@mono.jwplayer-ads-freewheel@mono.jwplayer-ads-googima@mono.jwplayer-ads-header-bidding@v6.3.0.jwplayer-ads-vast@mono.jwplayer-analytics@v3.40.0.jwplayer-analytics-kraken@v0.0.4.jwplayer-plugin-gapro@mono"
        },
        4225: function(t, e, n) {
            "use strict";
            n.d(e, {
        ...
        4671: function(t, e, n) {
            "use strict";
            var r, i = n(6875), o = n(8348), u = n(2799), a = [], c = [], s = [], l = {}, f = "screen"in window && "orientation"in window.screen, d = o.OS.android && o.Browser.chrome, p = !1, h = function(t, e) {
            ...
            var r = n(7462)
              ...
              , w = function(t) {
                var e = "file:" === window.location.protocol ? "https:" : ""
                  , n = {
                    bidding: "//ssl.p.jwpcdn.com/player/v/8.26.2/bidding.js",
                    jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.26.2/jwpsrv.js",
                    dai: "//ssl.p.jwpcdn.com/player/v/8.26.2/dai.js",
                    vast: "//ssl.p.jwpcdn.com/player/v/8.26.2/vast.js",
                    googima: "//ssl.p.jwpcdn.com/player/v/8.26.2/googima.js",
                    freewheel: "//ssl.p.jwpcdn.com/player/v/8.26.2/freewheel.js",
                    gapro: "//ssl.p.jwpcdn.com/player/v/8.26.2/gapro.js"
                }[t];
                return n ? e + n : ""
            }
              , b = function(t, e, n) {
              ...
              , C = function(t, e) {
                ...
                u.ei)(b, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "timeSlider", "width"]))),
                b.key = C,
                b.edition = j,
                b.error = P.error(),
        ...
        576: function(t, e, n) {
            ...
            var S = function(t) {
              ...
              , E = function(t) {
                var e, n;
                if (t ? "string" == typeof t ? (e = S(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = a.Z[t] : t.nodeType && (e = S((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = a.Z[0],
                e)
                    return e;
                if (n) {
                    var r = new x(n);
            ...
            L.utils.css.style = L.utils.style,
            L.vid = I.Z;
            var N = L
              , D = n(7543)
              , R = /^(?:on(?:ce)?|off|trigger)$/
        ...
        1918: function(t, e, n) {
            ...
            var r, i = n(386), o = [{
                ...
                return r || ((Boolean(navigator.requestMediaKeySystemAccess) && Boolean(window.MediaKeySystemAccess.prototype.getConfiguration) || Boolean(window.MSMediaKeys)) && (0,
        ...
        2963: function(t, e, n) {
            ...
            r.B.push({
                ...
                supports: function(t) {
                    return !(t.drm && !(0,
                    a.d3)(t.drm)) && (!(!window.HTMLVideoElement || !window.MediaSource) && (s(t.mediaTypes) && ("hls" === t.type || "dash" === t.type || "mpd" === t.type || (t.file || "").indexOf("mpd-time-csf") > -1)))
                }
            }),
            r.B.unshift({
                name: "hlsjs",
